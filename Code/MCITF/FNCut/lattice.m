...
%"4-connected" Cartesian(笛卡尔) lattice(网格) with dimensions X and Y. 
%
%Inputs:    X/Y - The dimensions of the lattice (i.e., the number of 
%               nodes(节点数) will equal X*Y)
%           connect - Optional iInteger indicating the connectivity of 
%               the lattice
%               0 - 4-connected (Default)4邻域
%               1 - 8-connected          8邻域
%               K>1 - Radially connected with radius = K(辐射半径)
%
