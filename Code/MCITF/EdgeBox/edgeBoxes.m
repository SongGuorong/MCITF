...
%
% The most important params are alpha and beta. The defaults are 
% optimized for detecting boxes at intersection over union (IoU) of 0.7. For 
% other settings of alpha/beta see the ECCV paper. In general larger alpha/beta
...
%
% The code uses the Structured Edge Detector to compute 
% edge strength and orientation. See edgesDetect.m for details. Alternatively, 
% the code could be altered to use any other edge detector such as Canny.
%
...
% confidence of detection. If the input is a cell array, the output 
% is a cell array where each element is a set of bbs in the form above (in this
...
%
% INPUTS 
%  I       - input image(s) of filename(s) of input image(s)(double[0,1])
